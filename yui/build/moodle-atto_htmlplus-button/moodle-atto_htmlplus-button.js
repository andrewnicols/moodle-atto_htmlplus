YUI.add('moodle-atto_htmlplus-button', function (Y, NAME) {
...
/**
 * @module     moodle-atto_htmlplus-button
 */

/**
 * Atto text editor HTML plugin.
 *
 * @namespace M.atto_htmlplus
 * @class button
 * @extends M.editor_atto.EditorPlugin
 */

Y.namespace('M.atto_htmlplus').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    "requires": [
        ...
        "moodle-atto_htmlplus-beautify",
        "moodle-atto_htmlplus-codemirror",
        "event-valuechange"
    ]
});
